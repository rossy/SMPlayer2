...
構成ダイアログは今すぐ表示されますので、それができます。</translation>
    ...
    <message>
        ...
        <translation>お使いのシステムにインストールされている MPlayer のバージョン (%1) は古いです。SMPlayer2 はよく動作できません: いくつかのオプションは動作しません、字幕の選択は失敗する可能性があります...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>SMPlayer2 - MPlayer のバージョンを入力</translation>
    </message>
    <message>
        <location filename="../inputmplayerversion.ui" line="35"/>
        <source>SMPlayer2 couldn&apos;t identify the MPlayer version you&apos;re using.</source>
        <translation>SMPlayer2 は使用中の MPlayer のバージョンを識別できませんでした。</translation>
    </message>
    <message>
...
例: resample=44100:0:0,volnorm</translation>
    ...
    <message>
        ...
        <translation>現在 MPlayer はローカル コードページ外の文字を含むファイル名を開くことができません。このオプションのチェックは SMPlayer2 にファイル名の短いバージョンを MPlayer へ渡させ、こうして開けるようになります。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>このオプションをチェックすると、MPlayer のビデオ ウィンドウは SMPlayer2 のメイン ウィンドウに埋め込まれず代わりに独自のウィンドウを使用します。マウスとキーボードのイベントは MPlayer によって直接ハンドルされ、それがキー ショートカットとマウス クリックがおそらく MPlayer のウィンドウにフォーカスがあるとき予期したとおり動作しないことに注意します。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>チェックされている場合、SMPlayer2 は MPlayer の出力 (&lt;b&gt;オプション -&gt; ログの表示 -&gt; MPlayer&lt;/b&gt; でご覧になれます) を格納します。問題の場合にこのログは重要な情報を含むことがあるので、このオプションのチェックを維持することが推奨されます。</translation>
    </message>
    <message>
...
For translators: don&apos;t translate this text, it will be replaced with another one at runtime.</source>
    ...
    <message>
        ...
        <translation>ここでは SMPlayer2 が使用する mplayer 実行ファイルを指定する必要があります。&lt;br&gt;SMPlayer2 は少なくとも MPlayer 1.0rc1 を必要とします (しかし SVN からの最近のリビジョンは強く推奨されます)。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>可能な値:&lt;br&gt; &lt;b&gt;はい&lt;/b&gt;: オーディオ トラックの切り替えに最速の方法を試行します (いくつかのフォーマットでは動作しない可能性があります).&lt;br&gt; &lt;b&gt;いいえ&lt;/b&gt;: MPlayer プロセスはオーディオ トラックの切り替え時にいつも再起動されます。&lt;br&gt; &lt;b&gt;自動&lt;/b&gt;: SMPlayer2 は MPlayer バージョンによってどうするかを決定します。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&apos;メディア&apos; はあらゆる SMPlayer2 が開けるファイルです。ローカル ファイル、DVD (例: dvd://1)、インターネット ストリーム (例: mms://....) または m3u または pls フォーマットのローカル プレイリストにできます。 -playlist オプションが使用されている場合、それは SMPlayer2 ではなく、MPlayer がプレイリストをハンドルするように、SMPlayer2 が MPlayer へ -playlist オプションを渡すことを意味します。</translation>
    </message>
    <message>
